...
- requiresDowntime: a boolean, optional, default=false, indicates whether the module requires downtime in support of maintenance windows during module upgrades
```
