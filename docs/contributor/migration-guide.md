...
| *n/a*                                          | `icons`                  | List of module icons for the UI with `name`+`link`                                                                                                                          |
| `mandatory`                                    | `mandatory`              | Marks the module as mandatory (default `false`)                                                                                                                             |
| *n/a*                                          | `requiresDowntime`       | Marks the module to require a maintenance window to update from previoius version (default `false`)                                                                         |
| *n/a*                                          | `security`               | Path to security scanner config. Must be a local path and will be be resolved against the checked out version on Gitub                                                      |
| *n/a*                                          | `labels` / `annotations` | Labels and annotations to put into the ModuleTemplate                                                                                                                       |
| *n/a*                                          | `manager`                | Controller resource of the module (GVK, name, optional namespace)                                                                                                           |
